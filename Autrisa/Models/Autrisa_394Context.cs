...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Investment>(entity =>
            {
                ...
                entity.Property(e => e.DollarsAmount).HasColumnType("decimal(18, 2)");
                ...
                entity.Property(e => e.SolesAmount).HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity<LendingOperation>(entity =>
            {
                ...
                entity.Property(e => e.Modality).HasComment("0: Transferencia, 1: Cheque, 2: Efectivo");

                entity.Property(e => e.Modified).HasColumnType("datetime");

                entity.Property(e => e.OperationDate).HasColumnType("datetime");

                entity.Property(e => e.Type).HasComment("0: Salida de dinero, 1: Ingreso de dinero");
